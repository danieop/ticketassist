...
<div class="container mt-5">
    ...
    <form action="addDiscount" method="POST">
      <input name="Service" value="addDiscount" hidden>
      <div class="mb-3">
      ...
      <select class="form-select" id="mainCategory" aria-label="Main Category">
        ...
        <c:forEach var="pro" items="${listPro}">
            <option data-id="${pro.getId()}" value="${pro.getId()}">${pro.getProviderName()}</option>
        </c:forEach>
      </select>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control datetimepicker" name="startDate" id="startDate" placeholder="Select start date and time">
    </div>
    <div class="mb-3">
      <label for="endDate" class="form-label">End Date</label>
      <input type="text" class="form-control datetimepicker"  name="endDate" id="endDate" placeholder="Select end date and time">
    </div>
    <div class="mb-3">
      <label for="percent" class="form-label">Discount Percent</label>
      <input type="number" class="form-control" id="percent" name="percent" placeholder="Enter discount percent">
    </div>
