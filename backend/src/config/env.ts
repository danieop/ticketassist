...
const envSchema = z.object({
  ...
  AI_MODEL_ANALYZER: z.string().trim().default("gpt-5.3-codex"),
  AI_MODEL_PRIORITY: z.string().trim().default("gpt-5.3-codex"),
  AI_MODEL_CODE_CONTEXT: z.string().trim().default("gpt-5.3-codex"),
  AI_MODEL_FIX_PROPOSAL: z.string().trim().default("gpt-5.3-codex"),
